...
namespace mercasmartPersistence.EntityFramework.Mapping
{
    public class ProductosMap
    {
        ...
        internal static void mapEntityFrameworkToModel(Productos efModel, out Models.Producto model)
        {
            ...
            mercasmartPersistence.Models.TiposProducto tipoProducto;
            Mapping.TiposProductoMap.mapEntityFrameworkToModel(efModel.TiposProducto, out tipoProducto);
            model.TipoProducto = tipoProducto;
